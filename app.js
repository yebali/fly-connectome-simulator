...
const M = {
  ...
  hold: 190,           // 기준 고도 (mm) — 이전엔 100. 낮게 나는 것의 실제 원인은
                       // 여기였다: 보이지 않는 천장(BOUND.y)은 원래도 600mm 라 파리가
                       // 다가갈 일이 거의 없었고, 실제 순항 고도를 정하는 건 이 값이다.
  bob: 70,             // 자발적 오르내림 폭 (모델)
...
const BOUND = { x: DESK.w / 2, z: DESK.d / 2, y: 700 };  // y: 보이지 않는 천장
